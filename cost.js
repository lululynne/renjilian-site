(function () {
  ...
  var I18N = {
    ...
    en: {
      pageTitle: "LLM costs",
      pageLede: "The shared subscription ledger on the table: China price, US price, a global average price, and a small sparkline placeholder. Not a bargain guide—just transparent bills.",
      ...
      ledeApi: "Public reference rates per 1M tokens. Currency follows the vendor list; most rows are still draft.",
      thModel: "Model",
      thIn: "Input / 1M",
      thOut: "Output / 1M",
      loadingApi: "Loading API rates…",
      secSetups: "How friends set up",
      ledeSetups: "Site readers are <strong>机友</strong> (friends); models and assistants are <strong>机机</strong>. Each card has a monthly-plans row and a devices row—concrete plans and models, ready for later submissions.",
